...
public class Order {
  ...
  protected Order(){}
  public Order(User user,Address address,BigDecimal subtotal,BigDecimal deliveryCharge,BigDecimal total,String paymentMethod){this.user=user;this.address=address;this.status="COD".equals(paymentMethod)?OrderStatus.CONFIRMED:OrderStatus.PENDING_PAYMENT;this.subtotal=subtotal;this.shippingAmount=deliveryCharge;this.deliveryCharge=deliveryCharge;this.totalAmount=total;this.paymentMethod=paymentMethod;}
